      ...
      */
      int direccionAleatoriaFrente(int direccion){
          switch(direccion){
              ...
              case 3:
                 return 2+rnd.nextInt((5)-2);
              case 4:
                 return 3+rnd.nextInt((6)-3);
              case 5:
                 return 4+rnd.nextInt((7)-4);
              case 6:
                  return 5+rnd.nextInt((8)-5);
              case 7:
                 int[] arr2 = {6,7,0};
                 return arr2[rnd.nextInt(2)];
...
/**Cambia la dirección de donde ve la termita a su dirección opuesta.
 * @param dir dirección a donde ve la termita
 * @return la direccion opuesta
 */
      int dameOpuesto(int dir){
          switch(dir){
              case 0:
                  return 4;
              case 1:
